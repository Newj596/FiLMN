...
parser.add_argument('--model-path', type=str,
                    default=r"D:\Writing\yolov5\runs\train\v5s-0.0001-0.649-20e\weights\best.pt",
                    help='Path to the model')
parser.add_argument('--img-path', type=str, default=r"D:\Writing\datasets\Fog\images\test_rtts\NY_Google_111.png",
...
parser.add_argument('--names', type=str, default="person, car, bus, bicycle, motorcycle",
