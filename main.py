...
class yolov5_heatmap:
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            self.process(img_path, f'{save_path}/result0.png')


def get_params():
    params = {
        # 'weight': r"D:\Writing\yolov5\runs\train\fine-0.0001-0.699-v5s-20e\weights\best.pt",
        'weight': r'D:\Writing\yolov5\runs\train\fine-0.760-v5x-0.0001-cbam-c-20e-5N\weights\best.pt',
        # 'weight': 'yolov5s.pt',
        'device': 'cuda:0',
        'method': 'GradCAM',
...
if __name__ == '__main__':
    ...
    model(r"D:\Writing\datasets\Fog\images\test_rtts", 'result_moe')
